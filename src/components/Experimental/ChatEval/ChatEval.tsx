    ...
    <>
      ...
      <PageSection>
        <Flex direction={{ default: 'column' }} gap={{ default: 'gapMd' }}>
          ...
          <FlexItem>
            <Content>
              View two models side-by-side to compare their responses to commands. To send commands to one or both models at a time, toggle the{' '}
              <b>Separate chat inputs</b> to switch.
            </Content>
          </FlexItem>
          <FlexItem>
