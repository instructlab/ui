...
export const createEmptySeedExample = (isSkillContribution = false): SeedExample => ({
  immutable: true,
  isExpanded: false,
  context: '',
...
export const createDefaultSeedExamples = (isSkillContribution = false): SeedExample[] => [
  createEmptySeedExample(isSkillContribution),
  createEmptySeedExample(isSkillContribution),
  createEmptySeedExample(isSkillContribution),
  createEmptySeedExample(isSkillContribution),
  createEmptySeedExample(isSkillContribution)
