import { KnowledgeFormData, SeedExample, SkillFormData } from '@/types';
...
const hasDuplicateKnowledgeSeedExamples = (seedExamples: SeedExample[]): { duplicate: boolean; index: number } => {
...
const hasDuplicateSkillSeedExamples = (seedExamples: SeedExample[]): { duplicate: boolean; index: number } => {
